...
public class MiAdaptador extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
          ...
          switch (Math.round((float)Math.random()*3)){
	          case 0:
	                 imageView.setImageResource(R.drawable.ic_asteroide1);
	                 break;
	          case 1:
	                 imageView.setImageResource(R.drawable.ic_asteroide2);
	                 break;
	          default:
	                 imageView.setImageResource(R.drawable.ic_asteroide3);
	                 break;
          }
          return view;
    }
